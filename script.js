...
const account4 = {
  ...
  pin: 4444,
  movementsDates: [
    '2019-10-02T18:15:33.035Z',
    '2019-10-30T03:48:16.867Z',
    '2019-12-25T06:04:23.907Z',
    '2020-04-25T19:18:46.235Z',
    '2020-02-05T16:33:06.386Z',
    '2021-03-10T14:43:26.374Z',
    '2021-06-25T13:49:59.371Z',
    '2022-02-26T09:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const startLogoutTimer = function () {
  ...
  // Set time to several minutes
  let time = 120;
  // call the timer in each second
  tick();
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // Display Current date and account
    const now = new Date();
    const options = {
      hour: 'numeric',
      minute: 'numeric',
